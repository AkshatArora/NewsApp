...
root=root.getJSONObject("response");
                JSONArray feature = root.getJSONArray("results");

                for (int i = 0; i < feature.length(); i++) {
                    JSONObject quake = feature.getJSONObject(i);

                    String sectionName =quake.getString("sectionName");
                    String webTitle = quake.getString("webTitle");

                    String page_url = quake.getString("webUrl");
                    newses.add(new News(sectionName,webTitle, page_url));
                }
